...
if (!empty($arrUser['PERSONAL_MOBILE'])) {
    $userPhone = $arrUser['PERSONAL_MOBILE'];
} elseif (!empty($arrUser['PERSONAL_PHONE'])) {
    $userPhone = $arrUser['PERSONAL_PHONE'];
}

$strCustomerPhone = FreedomPayIO::checkAndConvertUserPhone($userPhone);
