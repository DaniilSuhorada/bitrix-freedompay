...
class FreedomPayIO
{
     ...
     * @return void
     */
    public static function makeResponse($strScriptName, $strShopKey, $strStatus, $strDescription, $strSalt = null)
    {
        global $APPLICATION;
        if (!$strSalt) {
            $strSalt = uniqid();
        ...
        $arrResponse['pg_sig'] = FreedomPaySignature::make($strScriptName, $arrResponse, $strShopKey);
