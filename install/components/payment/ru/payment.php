...
$MESS["SPCP_DTITLE"] = "FreedomPay";
$MESS["SPCP_DDESCR"] = "Универсальная система приема платежей на сайте. Система электронных платежей для интернет магазинов
	<a href=\"https://freedompay.money/\" target=\"_blank\">FreedomPay</a>.";

$MESS["SHOP_MERCHANT_ID"] = "Идентификатор магазина в FreedomPay ( Merchant ID )";
$MESS["SHOP_MERCHANT_ID_DESCR"] = "используется для идентификации магазина при совершении платежей.";
...
$MESS["SHOP_TESTING_MODE_DESCR"] = "В случае если вы находитесь в боевом режиме, но вам нужно провести тестовый транзакции, устанавливаете флаг настройки и все транзакции будут создаваться по тестовым платежным системам.";
...
$MESS["SHOP_OFD"] = "ОФД";
$MESS["SHOP_OFD_DESCR"] = "Включить ОФД";

$MESS["SHOP_DELIVERY_IN_OFD"] = "Доставка в ОФД";
$MESS["SHOP_DELIVERY_IN_OFD_DESCR"] = "Учитывать доставку в ОФД";

$MESS["SHOP_TAX_TYPE"] = "Тип налога.";
$MESS["SHOP_TAX_TYPE_DESCR"] = "Тип налога.";
