...
class Helper
{
    public const PAYMENT_SYSTEM_NAME = 'FreedomPay';
    public const PAYMENT_SYSTEM_ID = 'freedompay.pay';

    public const FREEDOMPAY_API_URL = [
        'api.freedompay.money' => ['NAME' => 'api.freedompay.money'],
        'api.freedompay.uz'    => ['NAME' => 'api.freedompay.uz']
    ];
    public const PAYBOX_API_URL = [
        'api.paybox.money' => ['NAME' => 'api.paybox.money'],
        'api.paybox.ru'    => ['NAME' => 'api.paybox.ru']
    ];
